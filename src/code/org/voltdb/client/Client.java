...
public interface Client {
     ...
     */
    public VoltBulkLoader getNewBulkLoader(String tableName, int maxBatchSize, boolean upsert,String[] columns, BulkLoaderFailureCallBack failureCallback) throws Exception;
